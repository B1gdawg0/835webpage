...
function Navbar(){
    ...
    return(
        <>
        <nav className="flex justify-between items-center px-4 md:px-[60px] lg:px-[90px] bg-[#011C2A] h-[60px] md:h-[80px] lg:h-[104px] text-white shadow-md sticky top-0 z-20">
